...
def generate_welcome_message():
    ...
    prompt = f"Craft a brief message as if {name}, our {title}, is personally welcoming a visitor to the page. {name} specializes in {description}. it does not need to start with welcome it could be a brief introduction to the person then a welcome chose randomly The message should be 10 to 15 words and reflect a warm, inviting tone."
    try:
